...
from teleaus.helperFile import supportURL

# Model manipulation
##########################
from teleaus.models import QueryPatterns
...
def login(request):
    ...
    # username = inputQuery.GET["username"]
    # password = inputQuery.GET["password"]
...
# currentKBFile = 'data\\teleaus\\intents.json'
# previousKBFileCopy = 'data\\teleaus\\intentsPreviousCopy.json'
# stopWordsFile = 'data\\teleaus\\stop_words.txt'
# dataPickleFile = 'data\\teleaus\\data.pickle'
# mlModelFile = 'data\\teleaus\\ml_model.pkl'

currentKBFile = os.path.join('data/teleaus/intents.json')
previousKBFileCopy = os.path.join('data/teleaus/intentsPreviousCopy.json')
stopWordsFile = os.path.join('data/teleaus/stop_words.txt')
dataPickleFile = os.path.join('data/teleaus/data.pickle')
mlModelFile = os.path.join('data/teleaus/ml_model.pkl')
...
def respondWithSorry():
    ...
    sorryMessage = "Sorry, I don't understand. Try again with another question, or you can forward your enquiry towards our <a href=" + supportURL + " target=\"_blank\">Support Team</a>"
...
def chat(inputQuery):
    while True:
        try:
            ...
            temporaryInputMessage = inputQuery.POST['messageText'].encode('utf-8').strip()
